    ...
    return (
        <div className='pb-20 pt-36'>
            <div>
                ...
                w-[50vw]" fill="purple"/>
                <Spotlight  className="top-20 left-80 h-[80vw]
                w-[50vw]" fill="blue"/>
            </div>
            ...
            <div className="flex justify-center relative my-20 z-10">
                <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                    <h2 className="uppercase trackig-widest
                    text-xs text-cneter text-blue-100 max-w-80">
                        Dynamic Web Magic with Next.js
                    </h2>

                    <TextGenerateEffect 
                        className="text-center text-[40px] md:text-5xl lg:text-6xl"
                        words="Welcome to my page and show you my world "
                    />

                    <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
                        Hi, I&apos;m Yuto, a Full-Stack Developer based in Canada.
